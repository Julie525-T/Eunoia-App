...
//Define individual product variables
data class Product(
    val product_id: Int,
...
class ProductAdapter(private val productList: List<Product>) :
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        val imageUrl = "https://julie.alwaysdata.net/static/images/${product.product_photo}"
...
//        Handle Purchase Button Listener
        holder.btnPurchase.setOnClickListener {
            ...
            val intent = android.content.Intent(context, Payment::class.java).apply {
